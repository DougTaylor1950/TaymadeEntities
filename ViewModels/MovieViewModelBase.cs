...
namespace TaymadeEntities.ViewModels
{
    public class MovieViewModelBase : DialogModelBase
    {
       ...
       //private Movies? currentMovie;
        ...
        /// </summary>
        public ObservableCollection<string> SortOrders { get => sortOrders; set => this.RaiseAndSetIfChanged(ref sortOrders, value); }
        ...
        public int Volume { get => volume; set => this.RaiseAndSetIfChanged(ref volume, value); }
